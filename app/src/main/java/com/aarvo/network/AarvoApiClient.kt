...
class AarvoApiClient(
    ...
    suspend fun publishSellerProduct(productId: Int): JSONObject { require(productId > 0) { "Product ID must be positive" }; return post("/v1/seller/products/$productId/publish", JSONObject()) }
