...
class WelcomeActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        brand.addView(TextView(this).apply {
            ...
            setPadding(8, 0, 0, 0)
        }, LinearLayout.LayoutParams(-2, 68))
        root.addView(brand)
        ...
        root.addView(ShoppingBagsView(this), LinearLayout.LayoutParams(-1, 0).apply {
            weight = 1f
            topMargin = 4
            bottomMargin = 10
        })
        ...
        val guest = Button(this).apply {
            ...
            onClickListener = View.OnClickListener { enterApp() }
        }
        ...
        val login = Button(this).apply {
            ...
            setPadding(12, 0, 12, 0)
            onClickListener = View.OnClickListener { openLogin() }
        }
